\section{Ideal Battery}
    ...
    \subsection{Simulations}
        ...
        \subsubsection{Constant current}
            ...
            \begin{subfigure}{0.45\textwidth}
                \includegraphics[width=\linewidth]{soc_profile.png}
                \label{fig:soc_profile_constant_current}
            \end{subfigure} 
            \hfill
            \begin{subfigure}{0.45\textwidth}
                \includegraphics[width=\linewidth]{power_profile.png}
                \label{fig:power_profile_constant_current}
            \end{subfigure} 

            \begin{subfigure}{0.45\textwidth}
                \includegraphics[width=\linewidth]{voltage_profile.png}
                \label{fig:voltage_profile_constant_current}
            \end{subfigure} 
            \hfill
            \begin{subfigure}{0.45\textwidth}
                \includegraphics[width=\linewidth]{polarization_voltage.png}
                \label{fig:polarization_voltage_constant_current}
            \end{subfigure} 
