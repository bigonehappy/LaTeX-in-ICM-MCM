\section{Ideal Battery}
    ...
    \subsection{Parameter Estimation}
        ...
        %TODO: result inferred from the figure
    \subsection{Simulations}
        ...
        \subsubsection{Constant current}
            ...
            And the polarization voltages $U_1, U_2$ can also be solved analytically like equation \eqref{R_C_Estimation}.
        \subsubsection{Constant power}
            The output power
            \begin{equation}
                P = U_t I
            \end{equation}
            is constant. In this case, analytic solutions are impossible, so we use numerical methods, here the Rk45 algorithm.
        
        %TODO: figures of simulation results
